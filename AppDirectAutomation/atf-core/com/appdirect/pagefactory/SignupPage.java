...
public class SignupPage extends PageBase {
	...
	public Boolean validateSignUpConfirmation(String emailAddress){
		try {
			...
			//assertSafe.assertTrue(successContentLabel.getText().contains(emailAddress));
			//assertSafe.assertTrue(driver.getPageSource().contains(emailAddress));
			//assertSafe.assertTrue(successContentLabel.getText().contains(MessageConstants.SIGNUP_MAILBOX_CONFIRMATION));
